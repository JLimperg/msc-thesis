...
exposition top-down may skip to \secref{source:sizes} and return to this section
later.
...
of \icode{half}, with the predecessor of \icode{j} (i.e. \icode{i - 2}). This
has size \icode{o}, so we must use \icode{liftNat} to lift it to size \icode{n}.
...
module \icode{Source.\allowbreak Size}.
