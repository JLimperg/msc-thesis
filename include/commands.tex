...
% TODO boldface is a bit heavy.
\newcommand*{\category}[1]{\ensuremath{\mathord{\mathbf{#1}}}}
\newcommand*{\Cats}{\category{Cats}}
\newcommand*{\Sets}{\category{Sets}}
\newcommand*{\Sizes}{\category{Sizes}}
