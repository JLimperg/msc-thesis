...
types that demonstrates these advantages (though see \secref{background:sized}
...
model is fully formalised in Agda (without sized types); \chapref{formalisation}
