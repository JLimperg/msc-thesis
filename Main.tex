...
% IMPORT SETTINGS
\documentclass[12pt,a4paper,openright,fleqn]{report}
\input{include/settings}
\input{include/commands}

\newcommand{\oneLineTitle}{A Reflexive Graph Model of Sized Types}
\newcommand{\multiLineTitle}[1]{A Reflexive Graph Model of Sized Types}
...
\input{include/model}
\input{include/formalisation}
\input{include/negative}
