...
\icode{Model/\allowbreak RGraph.agda}.
...
\icode{Model/\allowbreak Size.agda}.
...
\icode{Model/\allowbreak Stream.agda}. Recall that $\Nat{n}$ is modelled by the
...
formalised in \icode{Model/\allowbreak Stream.agda}. Recall that the
